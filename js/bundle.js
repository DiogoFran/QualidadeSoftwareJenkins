...
var TodoApp = (function (_super) {
    ...
    //NEW FEATURE - BEGIN
    TodoApp.prototype.fetchData = async function (_this) {
      var todos = _this.props.model.todos;
      if (todos.length === 0) {
        var url = 'https://6435f69d3e4d2b4a12c84a40.mockapi.io/api/v1/random_list_of_items';
        try {
          var res = await fetch(url);
          var data = await res.json();
          var list = data.map(function(task){
            return {
              id: task.id,
              title: task.task,
              completed: false,
    ...
    TodoApp.prototype.render = function () {
        ...
        //NEW FEATURE - BEGIN
          ...
          loadBt = React.createElement("button", { className: "loadButton", onClick: function() {
...
var TodoModel = (function () {
    ...
    //NEW FEATURE - BEGIN
    TodoModel.prototype.fill = function (list) {
      this.todos = list;
      this.inform();
    };
    //NEW FEATURE - END
